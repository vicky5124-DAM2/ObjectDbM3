...
public class AppMoodle {
    ...
    public void gestionarDades2() {
        ...
        try {
            ...
            TypedQuery<Course> query = this.em.createNamedQuery("Course.findById", Course.class);
    ...
    public void gestionarDades3() {
        ...
        try {
            ...
            TypedQuery<Student> studentQuery = this.em.createNamedQuery("Student.findById", Student.class);
            studentQuery.setParameter("id", 63);

            Student student = studentQuery.getSingleResult();

            TypedQuery<Enrollment> enrollmentQuery = this.em.createNamedQuery("Enrollment.findByStudent", Enrollment.class);
    ...
    public void gestionarDades4() {
        ...
        try {
            ...
            TypedQuery<Course> courseQuery = this.em.createNamedQuery("Course.findById", Course.class);
    ...
    public void gestionarDades5() {
        ...
        try {
            ...
            TypedQuery<Teacher> teacherQuery = this.em.createNamedQuery("Teacher.findById", Teacher.class);
